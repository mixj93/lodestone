...
const dict = {
  ...
  "s": "撒洒飒萨塞腮赛散三叁伞丧嗓桑扫臊骚嫂搔色涩瑟森僧沙煞莎傻啥杀纱杉砂霎晒筛扇苫善擅膳赡山删衫珊跚闪陕裳上伤商尚晌赏梢少捎稍勺芍烧绍哨摄射蛇奢赊舌设社舍涉赦沈甚什审婶申伸身深呻绅神肾渗慎盛省升生声牲笙甥圣胜剩绳石拾食氏识十时实蚀噬史使始驶矢屎士示世市式势事侍饰试视柿是适室逝释誓拭恃嗜尸失师诗狮施湿虱寿受授售兽瘦狩手守首收数术属书叔殊梳舒疏输蔬抒枢淑暑鼠薯黍蜀署曙束述树竖恕庶墅漱熟秫赎刷耍衰帅蟀摔甩拴栓涮双霜爽水税睡谁吮顺瞬硕说烁伺思似司丝私斯撕嘶四寺饲肆死宋送诵颂讼松耸嗽搜艘苏宿俗诉肃素速塑粟溯酥蒜算酸岁碎穗祟遂隧虽随髓孙损笋缩唆梭嗦所索锁琐",
...
exports.handler = async (event, context) => {
  ...
  if (searchText !== "") {
    cardList = _.filter(classData[className].lightforge, c => {
      ...
      return (cardName.indexOf(searchText) > -1 || cardPingyin.indexOf(searchText) > -1);
    });
  }
